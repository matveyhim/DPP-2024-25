...
GStepper<STEPPER2WIRE> stepEL(16000, 3, 6, 8); // steps/rev, step, dir, en
GStepper<STEPPER2WIRE> stepAZ(32000, 2, 5, 8);
...
//  pix.setBrightness(brightness);
  ...
  stepEL.reverse(true);
  stepAZ.setAcceleration(500);
  stepEL.setAcceleration(500);
  stepAZ.setMaxSpeed(3000);//1500
  stepEL.setMaxSpeed(1000);//1000
...
//      cal();
  ...
  if (azSet== 49.0 and elSet== -15.0 and parking){
    stepAZ.disable();
    stepEL.disable();
    digitalWrite(A4, LOW);
  }else{
